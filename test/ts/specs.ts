...
export const specWithUnreferencedSchemasAndReferencingParams: OpenAPIV3.Document = {
  openapi: '3.0.2',
  info: { title: 'openspec with unreferenced schemas', version: '1.0.0' },
  components: {
    schemas: {
...
export const specWithWrongParamRef: OpenAPIV3.Document = {
  openapi: '3.0.2',
  info: { title: 'openspec with unreferenced schemas', version: '1.0.0' },
  components: {
    schemas: {
  ...
  paths: {
    '/test': {
      get: {
        ...
        parameters: [{$ref: '#/components/responses/aParam'}]
      },
      post: {
        operationId: 'a.create',
        tags: ['a'],
